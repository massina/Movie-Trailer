...
# The list of movies that will be rendered in the page.
movies = [wolf_wall_street, the_martian, the_bad_boys_2, red]

# Call this function to start generating the static movies page.
